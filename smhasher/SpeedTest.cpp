...
double SpeedTestCustom ( pfHash hash, uint32_t seed, const int trials, std::vector<uint64_t *> blocks )
{
  std::vector<double> times;
...
void BulkSpeedTestCustom ( pfHash hash, uint32_t seed, string input_filepath )
{
  ...
  double cycles = SpeedTestCustom(hash,seed,trials,blocks);
...
//-----------------------------------------------------------------------------
double HashMapSpeedTestCustom ( pfHash pfhash, const int hashbits,
                          string input_filepath,
                          const uint32_t seed, const int trials, bool verbose )
{
  std::vector<std::string> words = import_data_str(input_filepath);
